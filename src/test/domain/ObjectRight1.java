...
import es.cosm0s.converter.core.ConverterParser;

public class ObjectRight1 extends ConverterParser {
    ...
    public int getEnteroUno() {
        return enteroUno;
    }

    public void setEnteroUno(int enteroUno) {
        this.enteroUno = enteroUno;
    }
